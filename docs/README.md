...
| [`implementation/Pakta_Enmienda_Dev1_Scrum_v3.md`](implementation/Pakta_Enmienda_Dev1_Scrum_v3.md) | `web3` `scrum-v3` `handoff` | Propuesta para conciliar HU-D1-02 a HU-D1-13 con el vault, la firma del issuer y los criterios de aceptación verificables de Dev 1 |
